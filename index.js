...
async function getWeather(city){
    const response = await fetch(`https://api.weatherapi.com/v1/forecast.json?key=73ab6e334e1f4e74bf1225335230105&q=${city}&days=10&aqi=no&alerts=no`);
    ...
    forecastWeekday.forEach((day, i)=>{
        if(weather.forecast.forecastday[i+1]){
